...
const tiktokCommand = async (m, Fox) => {
  let selectedListId;
          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              header: proto.Message.InteractiveMessage.Header.create({
                 ...(await prepareWAMessageMedia({ image: { url: `https://i.ibb.co/SmvDLHb/Picsart-24-06-23-21-02-08-929.jpg` } }, { upload: Fox.waUploadToServer })),
                title: "",
                gifPlayback: true,
                subtitle: "",
