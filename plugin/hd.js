...
const reminiPath = path.resolve(__dirname, '../../src/hd.cjs');
...
const tourl = async (m, gss) => {
  ...
  if (validCommands.includes(cmd)) {
    ...
    try {
        ...
        gss.sendMessage(m.from, { image: proses, caption: `> *Hey ${m.pushName} Here Is Your Enhanced Image By RED_FOX-MD*` }, { quoted: m });
