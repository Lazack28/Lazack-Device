...
const tempMailCommand = async (m, Fox) => {
    ...
    if (cmd === 'tempmail') {
        try {
            ...
            const sentMsg = await Fox.relayMessage(msg.key.remoteJid, msg.message, {
        ...
        try {
            ...
            await Fox.relayMessage(updatedMsg.key.remoteJid, updatedMsg.message, {
