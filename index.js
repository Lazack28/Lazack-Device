...
// Add your config here or import from your config file
const config = {
    READ_MESSAGE: 'true',
    AUTO_STATUS_SEEN: 'true',
    AUTO_STATUS_REACT: 'true',
    AUTO_STATUS_REPLY: 'false',
    AUTO_STATUS__MSG: 'Hello, I saw your status!'
}
...
// --- Add your event handler code below this line ---
import { getContentType } from './lib/simple.js' // Already imported above, so skip if present
