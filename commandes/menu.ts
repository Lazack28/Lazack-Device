...
║    Developer : Lazack_28
  believe in you always remember you can even if it will take you time.
╚════--------------- \n\n`;
...
for(const cat in coms )
  {
    if(!emoji[cat]){emoji[cat]="🔋"}
      ...
      var link = "https://i.imgur.com/Hw2cYqN.mp4";


  try{
    zk.sendMessage(dest,{image:{url:link},caption:menuMsg,footer:"by lazack28"},{quoted:ms})
  }catch(e){console.log("🥵🥵 Menu error "+e); repondre("🥵🥵 Menu error "+e)}
