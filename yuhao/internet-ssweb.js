          ...
          axios({url: base + '/capture.php',
               ...
               if (data.data.status == 'success') {
                    axios.get(base + '/' + data.data.link, {
                       ...
                       let result = {
                            status: 200,
                            author: 'Nayla Hanifah',
                            result: data
                        }
                         resolve(result)
                    })
               } else {
                    reject({ status: 404, author: 'Nayla Hanifah', message: data.data })
               }
          }).catch(reject)
     })
}
