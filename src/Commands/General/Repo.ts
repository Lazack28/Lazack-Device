...
export default class extends BaseCommand {
    public override execute = async (M: Message): Promise<void> => {
        ...
        text += '⭐𝗜𝗻𝗳𝗼: This bot is using a base of WhatsApp-bot, we therefore don\'t have any copyright or either affiliated with WhatsApp-bot anyhowly. Thanks to jflex for base bot.\n';
        text += '(https://github.com/Lazack28/Lazack-md)\n\n';
